...
def get_trainer(persistence_directory):
    return Trainer(persistence_directory, _image_split, _image_size, _get_data, _build_model, batch_size, ms_per_batch, _get_x, _get_y, _get_count_from_y, custom_objects=custom_objects)
